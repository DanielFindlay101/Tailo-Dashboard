...
export default function DocumentCard({ title, status }: DocumentCardProps) {
  ...
  return (
    <div className="w-full flex gap-4 p-4 items-center bg-slate-800 hover:bg-slate-700 hover:cursor-pointer rounded-md">
      <DocumentTextIcon className="h-8 w-8 text-slate-100" />
